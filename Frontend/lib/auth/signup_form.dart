...
class _SignupFormState extends State<SignupForm> {
  ...
  Future<void> _signUp() async {
    if (!_emailVerified) {
      _showMessage('이메일 인증을 먼저 완료해주세요.', type: StatusType.error);
      return;
    }
    final email = _emailController.text.trim();
    ...
    try {
      ...
      _showMessage('회원가입 중 오류 발생: $e', type: StatusType.error);
    } finally {
